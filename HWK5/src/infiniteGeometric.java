...
public class infiniteGeometric {
	public static void main(String[] args) {
		...
		// If the common ratio is greater than 1, there is no sum for the geometric sequence
		if (ratio >= 1) {
			System.out.println("The infinite sequence does not have a sum.");
		}
			
		// If the common ratio is less than 1, there is a sum. Calculate the sum and print. 
		else {
			sum=first/(1-ratio);
